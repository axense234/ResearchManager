...
type CreateSettingsDtoOptionsType = {
...
export const createSettingsDtoOptions: CreateSettingsDtoOptionsType = {
  sidebarPosition: {
    example: 'LEFT',
    description:
  ...
  userId: {
    description:
      'The id of the User that will be connected to the newly created Settings. Input the respective User UUID as the value.',
  },
};
