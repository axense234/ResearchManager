...
type UpdateSettingsQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const updateSettingsQueryParamsApiPropertyOptions: UpdateSettingsQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
