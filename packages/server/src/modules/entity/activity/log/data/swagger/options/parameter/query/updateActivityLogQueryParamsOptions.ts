...
type UpdateActivityLogQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const updateActivityLogQueryParamsApiPropertyOptions: UpdateActivityLogQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
