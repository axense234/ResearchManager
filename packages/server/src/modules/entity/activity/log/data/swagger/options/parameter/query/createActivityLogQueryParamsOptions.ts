...
type CreateActivityLogQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const createActivityLogQueryParamsApiPropertyOptions: CreateActivityLogQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
