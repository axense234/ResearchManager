...
type CreateActivityFeedQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const createActivityFeedQueryParamsApiPropertyOptions: CreateActivityFeedQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
