...
type GetActivityFeedQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const getActivityFeedQueryParamsApiPropertyOptions: GetActivityFeedQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
