...
type DeleteActivityFeedQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const deleteActivityFeedQueryParamsApiPropertyOptions: DeleteActivityFeedQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
