...
type DeleteActivityDayQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const deleteActivityDayQueryParamsApiPropertyOptions: DeleteActivityDayQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
