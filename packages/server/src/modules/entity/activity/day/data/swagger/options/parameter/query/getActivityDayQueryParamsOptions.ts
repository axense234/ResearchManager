...
type GetActivityDayQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const getActivityDayQueryParamsApiPropertyOptions: GetActivityDayQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
