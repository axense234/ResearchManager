...
type DeleteResearchPhaseQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const deleteResearchPhaseQueryParamsApiPropertyOptions: DeleteResearchPhaseQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
