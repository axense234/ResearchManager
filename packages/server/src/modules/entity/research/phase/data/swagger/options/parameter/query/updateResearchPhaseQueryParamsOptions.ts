...
type UpdateResearchPhaseQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const updateResearchPhaseQueryParamsApiPropertyOptions: UpdateResearchPhaseQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
