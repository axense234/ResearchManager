...
type GetResearchPhaseQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const getResearchPhaseQueryParamsApiPropertyOptions: GetResearchPhaseQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
