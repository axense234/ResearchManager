...
type CreateResearchSessionQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const createResearchSessionQueryParamsApiPropertyOptions: CreateResearchSessionQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
