...
export const createResearchLogDtoOptions: CreateResearchLogDtoOptionsType = {
  ...
  userIdForArchivePurposes: {
    description:
      'The id of the User that will be connected to the newly created Research Log. Input the respective User UUID as the value. This is done for potential archive purposes.',
  },
};
