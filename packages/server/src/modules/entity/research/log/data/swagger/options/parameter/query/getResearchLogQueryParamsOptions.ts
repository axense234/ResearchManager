...
type GetResearchLogQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const getResearchLogQueryParamsApiPropertyOptions: GetResearchLogQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
