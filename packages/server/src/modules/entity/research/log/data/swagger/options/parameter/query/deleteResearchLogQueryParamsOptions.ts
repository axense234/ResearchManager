...
type DeleteResearchLogQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const deleteResearchLogQueryParamsApiPropertyOptions: DeleteResearchLogQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
