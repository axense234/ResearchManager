...
type UpdateResearchActivityQueryParamsApiPropertyOptionsType = {
  includeValues: ApiPropertyOptions;
  selectValues: ApiPropertyOptions;
  chosenOptionType: ApiPropertyOptions;
};

export const updateResearchActivityQueryParamsApiPropertyOptions: UpdateResearchActivityQueryParamsApiPropertyOptionsType =
  {
    includeValues: {
      required: false,
