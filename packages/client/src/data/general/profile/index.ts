...
export const profileResearchActivitiesData: PageSectionTitleProps = {
  ...
  description:
    "View your created Research Activities. You can also switch between viewing modes, filter by tags or/and number of research points and find a specific Research Activity by it’s name.",
};
