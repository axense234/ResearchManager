...
export const homeExamplesData: PageSectionTitleProps = {
  ...
  description: [
    ...
    "Research Activities are also split in Research Phases. By default, when creating a Research Activity a base Research Phase is created with the name and aesthetic of the Research Activity. Research Phases help with organizing the whole researching process, like having different phases for different projects.",
  ],
};
