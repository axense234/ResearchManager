...
> = ({ dto, dtoUpdateFunction, method }) => {
  ...
  const researchSessionDto = dto as
    | CreateResearchSessionDto
    | UpdateResearchSessionDto;
  ...
  return (
    <form className={entityOverlayFormControlsStyles.formControlsContainer}>
      <SelectFormControl
        currentEntityProperty={researchSessionDto?.researchPhaseId}
      ...
      />
      <TextFormControl
        labelContent="Session Name:"
        type="text"
        entityProperty={researchSessionDto?.name}
        onEntityPropertyValueChange={(e) =>
          dispatch(
            dtoUpdateFunction({
              key: "name",
        ...
        inputColorType="dark"
        labelColorType="dark"
        placeholderContent="ex: Session #1"
      ...
      <TextFormControl
        ...
        type="color"
        entityProperty={researchSessionDto?.backgroundColorOrImageSrc}
        onEntityPropertyValueChange={(e) =>
          dispatch(
            dtoUpdateFunction({
...
export default ResearchSessionOverlayFormControls;
